 ...
 */
public class UrlValidatorTest_EC extends TestCase {

   //private boolean printStatus = false;
   //private boolean printIndex = false;//print index that indicates current scheme,host,port,path, query test were using.
   //private String protocol[];

   public UrlValidatorTest_EC(String testName) {
      super(testName);
   }
   ...
   public void testRandomValidUrl() throws MalformedURLException {
	   ...
	   while (count <= 500) { //set number of random iterations
		  ...
		  System.out.println("[" + url.isValid(myRandomURL + end) + "]: " + myRandomURL + end);

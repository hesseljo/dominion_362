...
//modifed case logic to insert refactored 
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case adventurer:
      return newAdventurer(currentPlayer, state);

    case council_room:
      return newCouncil_room(currentPlayer, state, handPos);

    case mine:
      return newMine(currentPlayer, state, handPos, choice1, choice2);

    case smithy:
      return newSmithy(currentPlayer, state, handPos);
    
    case village:
      return newVillage(currentPlayer,state, handPos);
